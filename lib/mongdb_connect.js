 ...
 *
 */
var poolModule = require('generic-pool'), mongodb = require('mongodb'), msg = require('./msg/msg'), Db = mongodb.Db, ReplSetServers = mongodb.ReplSetServers, Connection = mongodb.Connection, Server = mongodb.Server, connect = mongodb
		.pure().connect, // 字符串式连接
connectString = _wants_config.MongodbConnectString, // 字符串式连接
defaultdbname = _wants_config.MongodbDefaultDbName, poolLogger = _wants_config.poolLogger, MongodbRC = _wants_config.MongodbRC, // 是否使用mongodb副本集
